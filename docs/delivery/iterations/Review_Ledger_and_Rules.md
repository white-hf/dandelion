...
| R0.8-CR-2026-05-23-I0.8.1-prospect-data-model | `docs/delivery/reviews/R0.8-CR-2026-05-23-I0.8.1-prospect-data-model.md` | R0.8 | M0.8 | Failed | 不允许进入 I0.8.2；必须补齐 website_status 筛选、20 条 seed 导入、prospects 测试、脚本密钥处理和数据库验证证据。 |
